...
btn1.addEventListener('click', function(){
 ...
 btn3.addEventListener("click",setMyLightGreen);
   ...
   */
   btn4.addEventListener('click', function(){setMyLightClass.apply(this, [event,"light-green"]);});
   ...
   *   and passing two aditional arguments, event and 'light-green'
   */
btn8.addEventListener("click", function(){setMyLightGreen.call(this, event,'light-green');});
...
btn9.addEventListener("click",()=>{setMyLightClass.call(btn9,event,"light-green");});
  /*
...
btn10.addEventListener("click", function(){setLight10Green();});
   ...
   */
const setLight11Green=setMyLightGreen.bind(btn11,null,'light-green');
...
const setLight12Green=setMyLightGreen.bind(btn12,event,'light-green');
btn12.addEventListener("click", function(){setLight12Green();});
  /*
   ...
   */
   ...
   btn13.addEventListener("click", function(event){setMyLightClass.bind(this, event,'light-green')();});
   ...
   */
   ...
   btn14.addEventListener("click", function(){setMyLightGreen.bind(this)();});
  /*
